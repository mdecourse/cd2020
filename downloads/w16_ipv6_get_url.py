    ...
    for studNum in eachGrp:
        ...
        if studNum[2] == "7":
            ...
            if studNum[4:6] == "31":
                ...
                # 乙班
                classNum = studNum[6:8]
                print("<a href='https://[2001:288:6004:17:2020:1::72" + str(classNum) + "]:" + port + "'>" + "https://[2001:288:6004:17:2020:1::71" + str(classNum) + "]:" + port + " (" + studNum + ")</a><br />")
            else:
            ...
            if studNum[4:6] == "31":
                ...
                # 乙班
                classNum = studNum[6:8]
                print("<a href='https://[2001:288:6004:17:2020:1::" + studNum[2]  + "2" + str(classNum) + "]:" + port + "'>" + "https://[2001:288:6004:17:2020:1::" + studNum[2] + "2" + str(classNum) + "]:" + port + " (" + studNum + ")</a><br />")
